...
gg.toast("🥦LOGS CLEARED SUCCESSFULLY🥦") 
end
...
gg.toast("😂HD Red Car Activated!🐰")
	...
	if mnl[2] == true then headl() end
	if mnl[3] == true then headbr() end
	if mnl[4] == true then START() end
	end
  ...
  gg.toast("Brutal Headhsot Done 🐾")
	...
	function GAME()
	gg.alert("Coming soon game feature, Lobby features are always safe\n By @ItzXEROX") 
	end
