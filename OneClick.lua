...
『👨‍🔧』WALL & COLOR",
"┌[Lobby] [Once]\
『🎴』ONE CLICK SAFE [LOBBY]",
"┌[Lobby] [Once]\
『🖲️』ONE CLICK BRUTAL [LOBBY]",
"┌[Lobby] [Once]\
『🤯』ONE CLICK SAFE [GAME]",
"┌[Lobby] [Once]\
...
"ⒺⓍⒾⓉ"} , nil, " [🏅] LTG™ OFFICIAL VIP SCRIPT 🏅\n [🥑] SCRIPT VERSION : 1.0.7 🏆\n [✍️] CODED BY : @ItzXEROX 🔐\n [🎖️] ONE CLICK MENU 💏") 
	...
	if MN == 2 then LSAFE() end
	if MN == 3 then LBRUTAL() end
	if MN == 4 then GSAFE() end
	if MN == 5 then GBRUTAL() end
