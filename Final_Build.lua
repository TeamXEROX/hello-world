...
if gg.isPackageInstalled("unluac_2019.jar.enc") then
  gg.alert("⚠️ ERROR :\n\n PLEASE UNINSTALL DECRYPT GG FRIST ")
  os.exit()
end
if gg.isPackageInstalled("com.cicib") then
  gg.alert("⚠️ ERROR :\n\n PLEASE UNINSTALL DECRYPT GG FRIST ")
  os.exit()
end
...
if gg.isPackageInstalled("sstool.only.com.sstool") then
  gg.alert("⚠️ ERROR :\n\n UNINSTALL SSTOOLS FOR RUN ✴ AR•STAR ✴")
  os.exit()
end
function Squid(A142)
  return (A142:gsub("..", function(A143)
    return string.char((tonumber(A143, 16) + 256 - 34 + 255999744) % 256)
  end))
end
if _G.debug.getinfo(gg.alert).source == "=[Java]" then
else
  i = 1
  gg.alert("⚠️ ERROR  : \n\n AUTO DECOMPILER DETECTED \n PLEASE DO NOT DECOMPILER MY SCRIPT ", "")
  gg.setVisible(false)
  while true do
    i = i + 1
    gg.toast("✴ ANTI LOG ACTIVE ✴")
    file = io.open("/storage/emulated/0/" .. i, "w")
    file:write("✴ STOP DECRYPT ✴")
    file:close()
    gg.setVisible(false)
    gg.processKill()
    gg.setVisible(true)
